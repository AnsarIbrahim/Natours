...
let global = module.exports = typeof window !== 'undefined' && window.Math == Math
    ...
    '../../node_modules/core-js/modules/_core.js': [
      function (require, module, exports) {
let core = module.exports = { version: '2.6.12' };
...
let isExtensible = Object.isExtensible || function () {
  ...
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    ...
    let THROWS_ON_PRIMITIVES = fails(() => { instance.has(1); });
            // most early implementations doesn't supports iterables, most modern - not close it correctly
    let ACCEPT_ITERABLES = $iterDetect((iter) => { new C(iter); }); // eslint-disable-line no-new
            // for early implementations -0 and +0 not the same
    let BUGGY_ZERO = !IS_WEAK && fails(() => {
  ...
  let fn = exp[KEY] = FORCE ? exec(trim) : spaces[KEY];
      ...
      function (require, module, exports) {
        ...
        var toNumber = function (argument) {
          ...
          if (typeof it === 'string' && it.length > 2) {
            ...
            var third; var radix; var maxCode;
    ...
    '../../node_modules/core-js/modules/es6.object.freeze.js': [
      function (require, module, exports) {
        ...
        require('./_object-sap')('freeze', ($freeze) => {
    ...
    '../../node_modules/core-js/modules/es6.object.get-own-property-descriptor.js':
      [
        function (require, module, exports) {
          ...
          require('./_object-sap')('getOwnPropertyDescriptor', () => {
...
let windowNames = typeof window === 'object' && window && Object.getOwnPropertyNames
    ...
    '../../node_modules/core-js/modules/es6.object.get-own-property-names.js': [
      function (require, module, exports) {
        ...
        require('./_object-sap')('getOwnPropertyNames', () => {
    ...
    '../../node_modules/core-js/modules/es6.object.get-prototype-of.js': [
      function (require, module, exports) {
        ...
        require('./_object-sap')('getPrototypeOf', () => {
    ...
    '../../node_modules/core-js/modules/es6.object.is-frozen.js': [
      function (require, module, exports) {
        ...
        require('./_object-sap')('isFrozen', ($isFrozen) => {
    ...
    '../../node_modules/core-js/modules/es6.object.is-sealed.js': [
      function (require, module, exports) {
        ...
        require('./_object-sap')('isSealed', ($isSealed) => {
    ...
    '../../node_modules/core-js/modules/es6.object.is-extensible.js': [
      function (require, module, exports) {
        ...
        require('./_object-sap')('isExtensible', ($isExtensible) => {
    ...
    '../../node_modules/core-js/modules/_task.js': [
      function (require, module, exports) {
        ...
        var defer; var channel; var port;
        var run = function () {
          var id = +this;
          // eslint-disable-next-line no-prototype-builtins
        ...
        var notify = function (promise, isReject) {
          ...
          microtask(() => {
            ...
            let run = function (reaction) {
              ...
              var {resolve} = reaction;
              var {reject} = reaction;
              let {domain} = reaction;
              var result; var then; var exited;
              try {
                if (handler) {
                  if (!ok) {
    ...
    '../../node_modules/core-js/modules/es6.reflect.set.js': [
      function (require, module, exports) {
        ...
        function set(target, propertyKey, V /* , receiver */) {
          ...
          var existingDescriptor; var proto;
          if (!ownDesc) {
            if (isObject((proto = getPrototypeOf(target)))) {
      ...
      var re2 = /b*/g;
        ...
        if (PATCH) {
          patchedExec = function exec(str) {
            let re = this;
            var lastIndex; var reCopy; var match; var i;
    ...
    '../../node_modules/core-js/modules/es6.regexp.match.js': [
      function (require, module, exports) {
        ...
        require('./_fix-re-wks')(
          'match',
          1,
          (defined, MATCH, $match, maybeCallNative) => {
            return [
    ...
    '../../node_modules/core-js/modules/es6.regexp.replace.js': [
      function (require, module, exports) {
        ...
        require('./_fix-re-wks')(
          'replace',
          2,
          (defined, REPLACE, $replace, maybeCallNative) => {
            return [
...
let SUPPORTS_Y = !fails(() => { RegExp(MAX_UINT32, 'y'); });

        // @@split logic
        require('./_fix-re-wks')(
          'split',
          2,
          (defined, SPLIT, $split, maybeCallNative) => {
            var internalSplit;
            if (
              'abbc'[$SPLIT](/(b)*/)[1] == 'c' ||
    ...
    '../../node_modules/core-js/modules/es6.regexp.search.js': [
      function (require, module, exports) {
        ...
        require('./_fix-re-wks')(
          'search',
          1,
          (defined, SEARCH, $search, maybeCallNative) => {
            return [
...
let setSymbolDesc = DESCRIPTORS && $fails(() => {
            return (
              _create(
                dP({}, 'a', {
                  get: function () {
...
let FAILS_ON_PRIMITIVES = $fails(() => { $GOPS.f(1); });
    ...
    '../../node_modules/core-js/modules/es6.string.anchor.js': [
      function (require, module, exports) {
        ...
        require('./_string-html')('anchor', (createHTML) => {
    ...
    '../../node_modules/core-js/modules/es6.string.big.js': [
      function (require, module, exports) {
        ...
        require('./_string-html')('big', (createHTML) => {
          return function big() {
    ...
    '../../node_modules/core-js/modules/es6.string.blink.js': [
      function (require, module, exports) {
        ...
        require('./_string-html')('blink', (createHTML) => {
    ...
    '../../node_modules/core-js/modules/es6.string.bold.js': [
      function (require, module, exports) {
        ...
        require('./_string-html')('bold', (createHTML) => {
    ...
    '../../node_modules/core-js/modules/es6.string.fixed.js': [
      function (require, module, exports) {
        ...
        require('./_string-html')('fixed', (createHTML) => {
    ...
    '../../node_modules/core-js/modules/es6.string.fontcolor.js': [
      function (require, module, exports) {
        ...
        require('./_string-html')('fontcolor', (createHTML) => {
    ...
    '../../node_modules/core-js/modules/es6.string.fontsize.js': [
      function (require, module, exports) {
        ...
        require('./_string-html')('fontsize', (createHTML) => {
    ...
    '../../node_modules/core-js/modules/es6.string.italics.js': [
      function (require, module, exports) {
        ...
        require('./_string-html')('italics', (createHTML) => {
    ...
    '../../node_modules/core-js/modules/es6.string.link.js': [
      function (require, module, exports) {
        ...
        require('./_string-html')('link', (createHTML) => {
...
let WEBKIT_BUG = /Version\/10\.\d+(\.\d+)?( Mobile\/\w+)? Safari\//.test(userAgent);
    ...
    '../../node_modules/core-js/modules/es6.string.small.js': [
      function (require, module, exports) {
        ...
        require('./_string-html')('small', (createHTML) => {
    ...
    '../../node_modules/core-js/modules/es6.string.strike.js': [
      function (require, module, exports) {
        ...
        require('./_string-html')('strike', (createHTML) => {
    ...
    '../../node_modules/core-js/modules/es6.string.sub.js': [
      function (require, module, exports) {
        ...
        require('./_string-html')('sub', (createHTML) => {
          return function sub() {
    ...
    '../../node_modules/core-js/modules/es6.string.sup.js': [
      function (require, module, exports) {
        ...
        require('./_string-html')('sup', (createHTML) => {
          return function sup() {
...
let TypedArrayConstructors = (
  ...
  let s = value < 0 || value === 0 && 1 / value < 0 ? 1 : 0;
    ...
    '../../node_modules/core-js/modules/es6.typed.array-buffer.js': [
      function (require, module, exports) {
        ...
        var toLength = require('./_to-length');
        var isObject = require('./_is-object');
        var {ArrayBuffer} = require('./_global');
        var speciesConstructor = require('./_species-constructor');
    ...
    '../../node_modules/core-js/modules/_typed-array.js': [
      function (require, module, exports) {
        ...
        if (require('./_descriptors')) {
          ...
          var $map = createArrayMethod(1, (O, length) => {
            return allocate(speciesConstructor(O, O[DEF_CONSTRUCTOR]), length);
          });

          let LITTLE_ENDIAN = fails(() => {
            // eslint-disable-next-line no-undef
            return new Uint8Array(new Uint16Array([1]).buffer)[0] === 1;
          });

  let FORCED_SET = !!Uint8Array && !!Uint8Array[PROTOTYPE].set && fails(() => {
  ...
  let TO_LOCALE_BUG = !!Uint8Array && fails(() => { arrayToLocaleString.call(new Uint8Array(1)); });
    ...
    '../../node_modules/core-js/modules/es6.typed.int8-array.js': [
      function (require, module, exports) {
        require('./_typed-array')('Int8', 1, (init) => {
    ...
    '../../node_modules/core-js/modules/es6.typed.uint8-array.js': [
      function (require, module, exports) {
        require('./_typed-array')('Uint8', 1, (init) => {
    ...
    '../../node_modules/core-js/modules/es6.typed.int16-array.js': [
      function (require, module, exports) {
        require('./_typed-array')('Int16', 2, (init) => {
    ...
    '../../node_modules/core-js/modules/es6.typed.uint16-array.js': [
      function (require, module, exports) {
        require('./_typed-array')('Uint16', 2, (init) => {
    ...
    '../../node_modules/core-js/modules/es6.typed.int32-array.js': [
      function (require, module, exports) {
        require('./_typed-array')('Int32', 4, (init) => {
    ...
    '../../node_modules/core-js/modules/es6.typed.uint32-array.js': [
      function (require, module, exports) {
        require('./_typed-array')('Uint32', 4, (init) => {
    ...
    '../../node_modules/core-js/modules/es6.typed.float32-array.js': [
      function (require, module, exports) {
        require('./_typed-array')('Float32', 4, (init) => {
    ...
    '../../node_modules/core-js/modules/es6.typed.float64-array.js': [
      function (require, module, exports) {
        require('./_typed-array')('Float64', 8, (init) => {
    ...
    '../../node_modules/core-js/modules/_collection-weak.js': [
      function (require, module, exports) {
        ...
        UncaughtFrozenStore.prototype = {
          ...
          delete: function (key) {
            var index = arrayFindIndex(this.a, (it) => {
              return it[0] === key;
            });
...
let $WeakMap = module.exports = require('./_collection')(WEAK_MAP, wrapper, methods, weak, true, true);
  ...
  let defineProperty = Object.defineProperty || function (obj, key, desc) { obj[key] = desc.value; };
  ...
  let Gp = GeneratorFunctionPrototype.prototype =
      ...
      while (true) {
        ...
        let i = -1; var next = function next() {
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW5zYXJpYnJhaGltIiwiYSI6ImNscW0yYnlieTAxOXAyaW13ZGVma3YyNDQifQ.OqVuLYL0JOoU6TmQf3Hr2Q';
